...
import AddAndEditSchool from '../../../components/grade/addAndEditGrade'
        ...
        <>
            <div className="grid">
                <Dialog visible={visible} maximizable style={{ width: '50vw' }} onHide={() => setVisible(false)}>
                    <AddAndEditGrade grades={grades} setGrades={setGrades} isNew={false} grade={grade} />
                </Dialog>
                <div className="col-12">
                    {grades?.length > 0 && <DataTableRenderer<Grade> data={grades} tableColumns={tableColumns} />}
                </div>
            </div>
        </>
    )
