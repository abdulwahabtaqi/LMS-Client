...
const QuestionList: React.FC<QuestionListProps> = (props) => {
    ...
    useEffect(() => {
        ...
        props?.filteredMcqQuestions,
        props?.filteredShortQuestions,
        props?.filteredLongQuestions,
        props?.selectedMcq,
        props?.selectedShortQuestion,
        props?.selectedLongQuestion,
        props?.filteredFillInTheBlanksQuestions,
        props?.filteredMultiFillInTheBlanksQuestions,
        props?.filteredMultipleShortQuestions,
        props?.filteredSequenceQuestions,
        props?.filteredMultipleTrueFalseQuestions,
    ...
    const reservedQuestions = async () => {
        try {
            ...
            const response = await createAssignment({ questionIds: uniqueArray, questionMode: props?.questionMode, name: exportName, userId: user?.id, assignData });
    ...
    return (
        <div className="grid">
            ...
            <Dialog header="Header" visible={exportNameVisible} style={{ width: '50vw' }} onHide={() => setExportNameVisible(false)}>
                <FormFieldWithLabel
                    label="Name for your assignment"
                    showCharLimit={false}
                    ...
                    formField={
                        <div className="flex flex-column gap-2">
                            ...
                            <small id="username-help">Enter name for this assignment</small>
                        </div>
                    }
                />
                <div className="gap-2">
                    <Button label={`Assign`} onClick={handleTriggerAssign} icon="pi pi-check" />
                </div>
            </Dialog>
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <TreeTable
                        ...
                        globalFilter={shortQuestionGlobalFilter}
                        header={shortQuestionHeaderRender}
                        selectionMode="checkbox"
                        selectionKeys={props?.selectedShortQuestion}
                        onSelectionChange={(e) => props?.setSelectedShortQuestion(e.value)}
                    >
                        <Column field="question" header="Name" expander />
                        <Column field="type" header="Type" />
                        <Column field="subTopic" header="Subtopic" />
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <TreeTable
                        value={fillInTheBlanksQuestions}
                        globalFilter={fillInTheBlanksGlobalFilter}
                        header={fillInTheBlanksHeaderRender}
                        selectionMode="checkbox"
                        selectionKeys={props?.selectedFillInTheBlanks}
                        onSelectionChange={(e) => props?.setSelectedFillInTheBlanks(e.value)}
                    >
                        <Column field="question" header="Name" expander />
                        <Column field="type" header="Type" />
                        <Column field="subTopic" header="Subtopic" />
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <TreeTable
                        value={multiFillInTheBlanksQuestions}
                        globalFilter={multiFillInTheBlanksGlobalFilter}
                        header={multiFillInTheBlanksHeaderRender}
                        selectionMode="checkbox"
                        selectionKeys={props?.selectedMultiFillInTheBlanks}
                        onSelectionChange={(e) => props?.setSelectedMultiFillInTheBlanks(e.value)}
                    >
                        <Column field="question" header="Name" expander />
                        <Column field="type" header="Type" />
                        <Column field="subTopic" header="Subtopic" />
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <TreeTable
                        value={multipleShortQuestions}
                        globalFilter={multipleShortGlobalFilter}
                        header={multipleShortQuestionsHeaderRender}
                        selectionMode="checkbox"
                        selectionKeys={props?.selectedMultipleShort}
                        onSelectionChange={(e) => props?.setSelectedMultipleShort(e.value)}
                    >
                        <Column field="question" header="Name" expander />
                        <Column field="type" header="Type" />
                        <Column field="subTopic" header="Subtopic" />
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <TreeTable
                        value={sequenceQuestions}
                        globalFilter={sequenceGlobalFilter}
                        header={sequenceQuestionsHeaderRender}
                        selectionMode="checkbox"
                        selectionKeys={props?.selectedSequence}
                        onSelectionChange={(e) => props?.setSelectedSequence(e.value)}
                    >
                        <Column field="question" header="Name" expander />
                        <Column field="type" header="Type" />
                        <Column field="subTopic" header="Subtopic" />
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <TreeTable
                        value={multipleTrueFalseQuestions}
                        globalFilter={multipleTrueFalseGlobalFilter}
                        header={multipleTrueFalseQuestionsHeaderRender}
                        selectionMode="checkbox"
                        selectionKeys={props?.selectedMultipleTrueFalse}
                        onSelectionChange={(e) => props?.setSelectedMultipleTrueFalse(e.value)}
                    >
                        <Column field="question" header="Name" expander />
                        <Column field="type" header="Type" />
                        <Column field="subTopic" header="Subtopic" />
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <TreeTable
                        value={multipleQuestionV2Questions}
                        globalFilter={multipleQuestionV2GlobalFilter}
                        header={multipleShortQuestionV2HeaderRender}
                        selectionMode="checkbox"
                        selectionKeys={props?.selectedMultipleShort}
                        onSelectionChange={(e) => props?.setSelectedMultipleQuestionV2(e.value)}
                    >
                        <Column field="question" header="Name" expander />
                        <Column field="type" header="Type" />
                        <Column field="subTopic" header="Subtopic" />
            ...
            <div className="col-12">
                <div className="card">
                    ...
                    <TreeTable
                        value={longQuestions}
                        globalFilter={longQuestionGlobalFilter}
                        header={longQuestionHeaderRender}
                        selectionMode="checkbox"
                        selectionKeys={props?.selectedLongQuestion}
                        onSelectionChange={(e) => props?.setSelectedLongQuestion(e.value)}
                    >
                        <Column field="question" header="Name" expander />
                        <Column field="type" header="Type" />
                        <Column field="subTopic" header="Subtopic" />
